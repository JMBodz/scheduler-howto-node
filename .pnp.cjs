...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState({
    ...
    "packageRegistryData": [
      ...
      ["date-format-lite", [
        ["npm:17.7.0", {
          "packageLocation": "./.yarn/cache/date-format-lite-npm-17.7.0-6bd485e907-b58c9cb226.zip/node_modules/date-format-lite/",
          "packageDependencies": [
            ["date-format-lite", "npm:17.7.0"]
          ],
          "linkType": "HARD",
